...
func main() {
	var (
		...
		toolsYAML        = flag.String("tools-yaml", "", "path to a tools.yaml function/table classification registry (enables sql_classify {denied,allowed}_function_classes)")
