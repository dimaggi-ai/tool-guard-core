...
For this release the backend was tested with real calls to two targets:
the hosted Jev service and a self-hosted judge running the open-source
[Laya](https://huggingface.co/convaiinnovations/laya) model (Apache-2.0).
